...
import { Search, MapPin, ShoppingCart, Menu, LogOut, Shield, Phone } from 'lucide-react';
        ...
        <div className="bg-gradient-to-r from-[oklch(0.22_0.10_260)] to-[oklch(0.18_0.08_260)] text-white py-2 px-4">
          <div className="container mx-auto flex justify-between items-center text-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="tel:9102171138"
                className="hidden md:flex items-center gap-1.5 hover:text-orange-300 transition-colors text-xs md:text-sm font-medium"
              >
                <Phone className="w-3.5 h-3.5" />
                <span>Call: 9102171138</span>
              </a>
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <a
                href="tel:9102171138"
                className="hidden md:flex items-center gap-2 px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-medium text-sm"
              >
